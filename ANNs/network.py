...
class Network:
    ...
    def SGD(self, data_train, epochs, minibatch_size, eta, data_test=None):
        if data_test:
        ...
        for j in range(epochs):
            ...
            if data_test:
                print('Epoch {}: {} / {}.'.format(j, self.evaluate(data_test), n_test))
            else:
    ...
    def minibatch_update(self, minibatch, eta):
        ...
        self.biases = [b - (eta/len(minibatch))*nb for b, nb in zip(self.weights, nabla_b)]
